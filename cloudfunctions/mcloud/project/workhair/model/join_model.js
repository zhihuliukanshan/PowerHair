...
JoinModel.DB_STRUCTURE = {
	...
	JOIN_CANCEL_TIME: 'int|false|defualt=0|comment=取消时间',
	...
	*/
	...
	JOIN_FEE: 'int|true|default=0|comment=需支付费用 分',

	JOIN_PAY_TRADE_NO: 'string|false|comment=商家订单号 32位',
	JOIN_PAY_STATUS: 'int|true|default=0|comment=支付状态 0=未支付 1=已支付 8=已退款 99=无需支付',
	JOIN_PAY_FEE: 'int|true|default=0|comment=已支付费用 分',
	JOIN_PAY_TIME: 'int|true|default=0|comment=支付时间',
